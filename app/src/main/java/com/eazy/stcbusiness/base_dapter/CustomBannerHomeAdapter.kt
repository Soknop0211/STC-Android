...
class CustomBannerHomeAdapter(private val mType: String, private val list: List<CustomCategoryModel>) : RecyclerView.Adapter<CustomBannerHomeAdapter.ViewHolder>() {
